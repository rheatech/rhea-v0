...
export function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      {/* Typography Overlay */}
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 pt-24 md:p-12 md:pt-32 md:px-12">
        {/* Top Left */}
        <motion.div
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — INFRASTRUCTURE</p>
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — ENTERPRISE</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            ENTERPRISE
            <br />
